  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-8 space-y-6 text-[#c9d1d9] select-none">
      <div className="glass-panel p-8 rounded-2xl border border-[#30363d] text-center space-y-4">
        <div className="w-16 h-16 rounded-full bg-[#58a6ff]/10 border border-[#58a6ff]/30 flex items-center justify-center mx-auto text-[#58a6ff]">
          <Laptop size={32} />
        </div>
        <div className="space-y-1">
          <div className="flex justify-center items-center gap-2">
            <h1 className="text-2xl font-black text-white">GitHub Codespaces</h1>
          ...
          <p className="text-xs text-[#8b949e] max-w-md mx-auto leading-relaxed">
            Launch instant cloud development environments configured with containerized tools and extensions.
          </p>
        </div>
